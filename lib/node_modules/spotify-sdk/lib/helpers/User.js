...
var _entitiesUserEntity = require('../entities/UserEntity');

var _entitiesUserEntity2 = _interopRequireDefault(_entitiesUserEntity);
...
var User = (function (_UserEntity) {
  ...
  _createClass(User, [{
    ...
    value: function playlists(id) {
      return new _handlersUserHandler2['default']().playlists(this.id, id);
    }
    ...
    value: function contains(type, ids) {
      return new _handlersUserHandler2['default']().contains(type, ids);
    }
    ...
    value: function top(type, query) {
      return new _handlersUserHandler2['default']().top(type, query);
    }
  }]);

  return User;
})(_entitiesUserEntity2['default']);
