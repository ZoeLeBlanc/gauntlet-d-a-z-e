...
var _entitiesTrackEntity = require('../entities/TrackEntity');

var _entitiesTrackEntity2 = _interopRequireDefault(_entitiesTrackEntity);
...
var Track = (function (_TrackEntity) {
  ...
  function Track(data) {
    ...
    _get(Object.getPrototypeOf(Track.prototype), 'constructor', this).call(this, data);
  }
  ...
  _createClass(Track, [{
    ...
    value: function audioFeatures() {
      return new _handlersTrackHandler2['default']().audioFeatures(this.id);
    }
  }, {
    key: 'artists',
    get: function get() {
